...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', help='experiment configure file name', default='/tt/nas/truecut_workspace/qhong/MM/waftmm/config/a2/dinov3/kousei-v1.json', type=str)
    parser.add_argument('--seed', help='seed', default=42, type=int)
    parser.add_argument('--reload_data', help='restore checkpoint', action='store_true')
    parser.add_argument('--data_root', help='data_root', default='/tt/nas/truecut_workspace/qhong/data/optical_flow_datasets', type=str)
    ...
    if args.reload_data:
        ...
        from utils.data_prepare import train_data_prepare
        ...
        train_data_prepare(args.data_root,args.pkl_root,datasets,input_frames=2,skip_frames=1)
    # if world_size > 1:
